...
3- zip dosyaasının içindeki csv dosyalarının tüm içeriğini tek bir csv dosyası yapın ,volume olmadan,
4- bu kayıtların tamamını sqlite veritabanına bir tablo oluşturarak yükleyin
5- kullanıcının belirlediği paritenin kullanıcının bellirlediği aralığının kullanıncın belirlediği
